...
const ChatItem = () => {
    ...
    return (
        <Button onClick={() => setactive(!active)} className="flex flex-no-wrap items-center pr-3 text-black rounded-lg cursor-pointer mt-200 py-65 hover:bg-gray-200"
            style={{
            ...
            <div className="flex justify-between w-full focus:outline-none">
                <div className="flex justify-between w-full">
                    <div
                        className="relative flex items-center justify-center w-12 h-12 mr-2 text-xl font-semibold text-white bg-blue-500 rounded-full flex-no-shrink">
                    ...
                    <div className="items-center flex-1 min-w-0">
                        <div className="flex justify-between mb-1">
                            <h2 className="text-sm font-semibold "
                                ...
                                Lauri Edmon</h2>
                            <div className="flex">
                                <svg className="w-4 h-4 text-green-500 fill-current"
                                ...
                                <span className="ml-1 text-xs font-medium text-gray-600" style={{
                                    color: active ? "white" : "black"
                                }}>12.52</span>
                            </div>
                        </div>
                        <div className="flex justify-between text-sm leading-none truncate">
                            ...
                            <span v-else
                                className="flex items-center justify-center text-xs text-right text-white bg-green-500 rounded-full"
                                style={{
                                    minWidth: "20px",
                                    minHeight: "20px"
                                }}>2</span>
